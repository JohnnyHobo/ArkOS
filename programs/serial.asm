; ------------------------------------------------------------------
; Minicom-like program for ArkOS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your ArkOS machine and Linux machine.
; Start ArkOS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the ArkOS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'ArkOS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting ArkOS minicom; press a key to return to ArkOS', 13, 10, 0
