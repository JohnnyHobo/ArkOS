...
; floppy for KERNEL.BIN (the ArkOS kernel), loads it and executes it.
...
OEMLabel		db "ARKBOOT"	; Disk label
...
VolumeLabel		db "ARKOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; ArkOS kernel filename
