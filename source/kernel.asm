; ==================================================================
; ArkOS -- The Ark Operating System kernel
; Copyright (C) 2006 - 2014 ArkOS Developers -- see doc/LICENSE.TXT
;
...
; ==================================================================
	...
	%DEFINE ARKOS_VER '4.5'	; OS version number
	%DEFINE ARKOS_API_VER 16	; API version for programs to check
...
; and are used in programs/arkdev.inc so that an external program can
; use a ArkOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as ArkOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to ArkOS', 0
	os_version_msg		db 'Version ', ARKOS_VER, 0

	dialog_string_1		db 'Thanks for trying out ArkOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute ArkOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of ArkOS, and', 0
